...
int main(int argc, char ** argv){
 ...
 // Sauvegarde les données de l'expérience.alpha=4
   save_values(time_analysis, "../plots/dynamic_array_time_c_sqrt.plot");
  save_values(copy_analysis, "../plots/dynamic_array_copy_c_sqrt.plot");
  save_values(memory_analysis, "../plots/dynamic_array_memory_c_sqrt.plot");
